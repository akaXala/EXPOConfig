// src/app/api/cartel/subir/route.ts
...
export async function POST(req: NextRequest) {
  try {
    ...
    const uniqueFilename = `plantilla_cartel_EXPOESCOM${ext}`;
    ...
    const allowedMimeTypes = ['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.presentationml.presentation'];
